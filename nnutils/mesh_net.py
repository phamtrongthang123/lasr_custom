...
class LASR(MeshNet):
    def __init__(self, input_shape, opts, nz_feat=100):
        ...
        # print( self.rest_rs.shape) # [20,4]
        # print(self.transg.shape)    # [20,3]
        # print(self.ctl_rs.shape)    # [320,4]
        # print(self.rest_ts.shape)   # [320,3]
        # print(self.ctl_ts.shape)    # [320,3]
        # print(self.log_ctl.shape)   # [320,3]
